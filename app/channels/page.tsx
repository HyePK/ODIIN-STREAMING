...
export default async function ChannelsPage() {
  ...
  return <main className="channels-page">
    <header><a href="/"><img src="/odiin-mark.svg" alt="" /><b>ODIIN</b> STREAMING</a><span>Creator network</span></header>
    <section className="channels-directory">
      ...
      {channels.length ? <div className="channels-grid">{channels.map((channel) => <a href={`/channel/${encodeURIComponent(channel.slug)}`} key={channel.slug}>
      ...
      </a>)}</div> : <div className="channels-empty"><img src="/odiin-mark.svg" alt="" /><h2>Creator channels are coming soon</h2><p>Active paid creator channels will appear here automatically.</p></div>}
    </section>
  </main>;
}
